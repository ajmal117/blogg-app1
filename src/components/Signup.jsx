    ...
    <>
      <section className="h-100 bg-dark ">
        <div className=" py-5 h-100">
          <div className="row flex justify-center items-center h-100">
            <div className="col">
                  ...
                  <div className="col-xl-6">
                    <form action="" onSubmit={handleSubmit}>
                      <div className="card-body p-md-5 text-black">
                        ...
                        <div className="d-mflex justify-content-start align-items-center mb-4 py-2">
                        ...
                        <div className="row">
                          <div className="col-md-6 mb-4">
                            <select
                              className="select border rounded w-full py-2 px-3"
                              name="city"
                              onChange={handleFormChange}
                            >
                        ...
                        <div className="row">
                          <div
                            className="autocomplete mb-4 border "
                            ref={autocompleteRef}
                          >
                            <input
                              type="text"
